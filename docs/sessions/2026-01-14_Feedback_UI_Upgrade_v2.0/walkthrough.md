...
## 9. Score Summary UI Redesign (v3.0)
Optimized typography and context for maximum usability.

**Key Changes:**
1.  **Typography**: 
    -   Reduced percentage font size (`text-4xl`) to fit perfectly within the ring.
    -   Increased stat numbers (`text-3xl`) for readability.
2.  **Context**: Added clear instruction "Scan QR Code to answer survey" for mobile users.
3.  **Refined Advice**: Updated default tip to focus on "Movement Quality" rather than just "Muscle Memory".
4.  **Layout**: 
    -   Clean 3-column stats grid.
    -   Limited top errors to 3 items to prevent overflow.
