...
| F-08 | **Display Options** | ปรับการแสดงผล 8 รูปแบบ (Path, Instructor, Ghost, Skeleton, Trail, Silhouette, Debug, Background Blur) |
...
| SRS-02-17 | ระบบต้องรองรับการเบลอพื้นหลัง (Virtual Background) ด้วย WebGL |
