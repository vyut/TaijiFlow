...
|:---:|-------------|-------|
| NFR-01 | Frame Rate | UI ≥ 30 FPS, AI Analysis ≥ 5 FPS (Dynamic) |
...
*Note: การใช้งานบน Tablet ได้รับการสนับสนุนผ่าน **Performance Mode (Lite)** เพื่อป้องกันความร้อนสะสม ส่วนฟีเจอร์ Visual Effects (Blur Background) จะถูกปิดอัตโนมัติในโหมดนี้*
