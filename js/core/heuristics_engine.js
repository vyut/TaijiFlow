...
class HeuristicsEngine {
  constructor() {
    ...
    this.RULES_CONFIG = {
      L1: {
        ...
        checkCoordination: false, // ✘ ไม่เช็ค
      },
      L2: {
      ...
      L3: {
        // --- Level 3: ท่ายืนย่อ/ขาคู่ (ยากที่สุด - 9 กฎ) ---
        ...
        checkCoordination: true, // ✔ เพิ่ม: บนล่างสัมพันธ์กัน (Rule 9)
      },
    };
    ...
    this.RULE_PRIORITY = {
      ...
      // Priority 8-9: สไตล์ (ความลื่นไหล)
      Smoothness: 8, // เคลื่อนไหวสะดุด
      Continuity: 9, // หยุดนิ่ง
    };
  ...
  */
  ...
  // ---------------------------------------------------------------------------
  /**
   * ตรวจสอบความสอดคล้องระหว่างมือและสะโพก (การถ่ายน้ำหนัก)
   * หลัก "上下相随" (ซ่างเซี่ยเซียงสุย) - บนล่างสัมพันธ์กัน ขยับเป็นหนึ่งเดียว
   *
   * Logic:
   *   1. คำนวณความเร็ว (Velocity) ของมือและสะโพกในแกน X (แนวนอน)
   *   2. ถ้าความเร็วสูงพอ (เกิน Threshold) ให้เช็คทิศทาง (+/-)
   *   3. ถ้าทิศทางสวนทางกัน (Conflict) = ผิดหลักการ
   *
   * @param {Object} wrist - ตำแหน่งข้อมือ {x, y}
