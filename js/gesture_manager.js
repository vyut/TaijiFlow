 ...
 * ควบคุม UI ด้วยท่ามือ โดยใช้ MediaPipe Gesture Recognizer
 *
 * Gestures:
 * - 👍 Thumb_Up: เริ่มการฝึก (hold 2 วินาที)
 * - ✊ Closed_Fist: หยุดการฝึก (hold 2 วินาที)
 */
...
class GestureManager {
  constructor() {
    ...
    this.HOLD_DURATION_MS = 2000; // 2 วินาที

    // Callbacks
    this.onStartTraining = null;
    this.onStopTraining = null;

    // UI elements
    this.overlayEl = null;
    this.progressEl = null;
    this.gestureTextEl = null;
