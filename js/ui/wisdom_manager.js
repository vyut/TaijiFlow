...
class WisdomManager {
  ...
  show() {
    ...
    const html = `
      <div class="relative w-full max-w-lg bg-white/90 dark:bg-gray-900/50 backdrop-blur-xl rounded-2xl border border-white/20 dark:border-gray-700/50 shadow-2xl overflow-hidden flex flex-col items-center p-8 transform scale-95 animate-[scaleIn_0.3s_cubic-bezier(0.16,1,0.3,1)_forwards]">
