  ...
  th: {
    ...
    score_popup: {
      ...
      motivational_quotes: [
        ...
        { zh: "上善若水", text: "ความดีสูงสุดเปรียบดั่งน้ำ" },
        { zh: "無為而治", text: "ไม่ฝืน แต่ทุกอย่างเป็นไปตามธรรมชาติ" },
        { zh: "知止而後有定", text: "รู้จักหยุด จึงมีความสงบ" },
        {
          zh: "靜中有動，動中有靜",
          text: "ในความสงบมีการเคลื่อนไหว ในการเคลื่อนไหวมีความสงบ",
        },
        { zh: "太極生兩儀", text: "จากไท่จี๊เกิด หยิน-หยาง" },
        { zh: "剛柔並濟", text: "แข็งและอ่อนผสานเป็นหนึ่ง" },
        { zh: "心靜則明", text: "จิตสงบ ย่อมเห็นแจ้ง" },
        { zh: "慢練快用", text: "ฝึกช้า ใช้เร็ว" },
        { zh: "積少成多", text: "สะสมน้อยรวมเป็นมาก" },
        { zh: "氣沉丹田", text: "จมพลังลงสู่ตันเถียน" },
      ],
    },
  ...
  en: {
    ...
    score_popup: {
      ...
      motivational_quotes: [
        ...
        { zh: "上善若水", text: "The highest goodness is like water" },
        { zh: "無為而治", text: "Non-action, yet nothing is left undone" },
        {
          zh: "知止而後有定",
          text: "Know when to stop, and you will find peace",
        },
        {
          zh: "靜中有動，動中有靜",
          text: "Stillness within movement, movement within stillness",
        },
        { zh: "太極生兩儀", text: "From Taiji, Yin and Yang are born" },
        { zh: "剛柔並濟", text: "Hardness and softness complement each other" },
        { zh: "心靜則明", text: "A calm mind brings clarity" },
        { zh: "慢練快用", text: "Practice slowly, apply quickly" },
        {
          zh: "積少成多",
          text: "Small efforts accumulate into great achievements",
        },
        { zh: "氣沉丹田", text: "Sink your Qi to the Dantian" },
      ],
    },
