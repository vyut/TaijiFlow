...
window.TRANSLATIONS = {
  ...
  th: {
    ...
    landing_hero_btn_start: "▶️ เข้าสู่การฝึก",
    landing_hero_btn_guide: "📖 คู่มือใช้งาน",

    landing_about_title: "เกี่ยวกับโครงการ",
    landing_about_origins_title: "📜 ที่มาของโครงการ",
    ...
    landing_about_tech_title: "💻 เทคโนโลยี",
    landing_about_features_title: "✨ จุดเด่น",
    landing_feat_1:
    ...
    landing_about_arch_title: "🏗️ สถาปัตยกรรมระบบ",
    landing_arch_1:
      "📷 <strong>Input:</strong> รับภาพวิดีโอจาก Webcam พร้อมปรับเทียบสัดส่วนร่างกาย (Calibration) ผู้ฝึกอัตโนมัติ",
    landing_arch_2:
      "⚙️ <strong>Processing:</strong> สกัดจุด Keypoints 33 จุดด้วย MediaPipe Pose และคำนวณความถูกต้องผ่าน Heuristic Engine",
    landing_arch_3:
      "📊 <strong>Output:</strong> แสดงกราฟิก (Skeleton/Path/Instructor) แจ้งเตือนด้วยภาพและเสียง สรุปผลการฝึกและประเมินเกรด",
    ...
    landing_about_tech_1:
      "<strong>MediaPipe Pose</strong> - Computer Vision ตรวจจับท่าทาง",
    landing_about_tech_2:
      "<strong>MediaPipe Gesture</strong> - ระบบสั่งงานด้วยมือ",
    ...
    landing_guide_step1_title: "เตรียมตัว",
    ...
    landing_guide_warnings_title: "⚠️ ข้อควรระวัง",
    landing_warn_1:
    ...
    landing_ref_what_title: "🌀 ท่าม้วนไหมคืออะไร?",
    ...
    landing_ref_principles_title: "⚖️ หลักสำคัญ",
    ...
    landing_ref_benefits_title: "🎁 ประโยชน์",
    ...
    landing_ref_how_title: "🧘 วิธีการฝึก",
    ...
    alert_low_light_critical_short: "แสงสว่างน้อยเกินไป",
  ...
  en: {
    ...
    landing_hero_btn_start: "▶️ Start Training",
